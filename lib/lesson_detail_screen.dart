    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text(AppStrings.of(context).wellDone, textAlign: TextAlign.center,
            style: TextStyle(fontWeight: FontWeight.w800, color: Color(0xFF1A56F6))),
        content: Text(
          AppStrings.of(context).lessonCompleted(widget.lesson['title'] ?? '', _words.length),
          textAlign: TextAlign.center,
          style: const TextStyle(fontSize: 16, color: Color(0xFF2E384D)),
        ),
        ...
        actions: [
          ElevatedButton(
            ...
            child: Text(AppStrings.of(context).finish, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
