...
class AppStrings {
  ...
  String get createAccount =>
      _isEn ? 'Create an account here' : 'Tạo tài khoản mới';
  ...
  String get termsOfUse => _isEn
      ? 'By signing up you agree with our Terms of Use'
      : 'Bằng việc đăng ký, bạn đồng ý với Điều khoản sử dụng';
  String get newMember => _isEn ? 'New member? ' : 'Chưa có tài khoản? ';
  String get alreadyMember =>
      _isEn ? 'Already a member? ' : 'Đã có tài khoản? ';
  String get signInSuccess =>
      _isEn ? 'Sign in successful!' : 'Đăng nhập thành công!';
  String get signUpSuccess =>
      _isEn ? 'Sign up successful!' : 'Đăng ký thành công!';
  ...
  String get pleaseEnterEmail =>
      _isEn ? 'Please enter an email!' : 'Vui lòng nhập email!';
  ...
  String noWordFound(String query) =>
      _isEn ? "No word found: '$query'" : "Không tìm thấy từ: '$query'";
  ...
  String get letsReview =>
      _isEn ? "Let's review some words" : 'Cùng ôn tập từ vựng nhé';
  String get wordOfTheDay => _isEn ? 'Word of the Day' : 'Từ vựng của ngày';
  String get dailyChallenge =>
      _isEn ? 'Daily Challenge' : 'Thử thách hàng ngày';
  ...
  String get reviewWordsSubtitle =>
      _isEn ? 'Words due for review today' : 'Các từ đến hạn ôn hôm nay';
  String wordsDueToday(int count) =>
      _isEn ? '$count word${count == 1 ? '' : 's'} due' : '$count từ cần ôn';
  ...
  String get diamond => _isEn ? 'Diamond' : 'Kim cương';
  ...
  String get xpToNextLevel => _isEn ? 'XP to next level' : 'XP lên cấp tiếp';

  // --- Flashcard ---
  String get tapToSeeExamples =>
      _isEn ? 'Tap to see examples' : 'Chạm để xem ví dụ';
  String get tapToSeeDefinition =>
      _isEn ? 'Tap to see definition' : 'Chạm để xem định nghĩa';
  ...
  String get noExamples =>
      _isEn ? 'No examples available' : 'Chưa có ví dụ cho từ này';
  String get noAudio => _isEn
      ? 'No audio available for this word!'
      : 'Không có âm thanh cho từ này!';

  // --- Courses Screen ---
  String get chooseTopicToLearn =>
      _isEn ? 'Choose a topic to start learning' : 'Chọn chủ đề để bắt đầu học';
  ...
  String lessonWithTitle(String title) {
    ...
    String cleanTitle = title.replaceAll(
      RegExp(r'^(Lesson|Bài học)\s*', caseSensitive: false),
      '',
    );
  ...
  String topicWithTitle(String title) {
    ...
    if (foundKey != null) {
      return _isEn
          ? topicMap[foundKey]!
          : (foundKey == title.toLowerCase() ? title : foundKey);
    }
  ...
  String savedAccountsCount(int count) =>
      _isEn ? 'Saved accounts ($count/5)' : 'Tài khoản đã lưu ($count/5)';
  String get termsOfService =>
      _isEn ? 'Terms of Service' : 'Điều khoản dịch vụ';
  ...
  // --- Achievements / Badges ---
  String get achievements => _isEn ? 'Achievements' : 'Thành tựu';
  String get achievementsSubtitle => _isEn
      ? 'Complete challenges to unlock badges.'
      : 'Hoàn thành thử thách để mở khóa huy hiệu.';
  String badgesProgress(int unlocked, int total) =>
      _isEn ? '$unlocked / $total unlocked' : 'Đã mở $unlocked / $total';
  String get badgeUnlocked => _isEn ? 'Badge unlocked!' : 'Mở khóa huy hiệu!';
  String get badgeLocked => _isEn ? 'Locked' : 'Chưa mở';
  String get badgeUnlockedStatus => _isEn ? 'Unlocked' : 'Đã mở khóa';
  String get profileBadge => _isEn ? 'Profile badges' : 'Huy hiệu hồ sơ';
  String get profileBadgeSubtitle => _isEn
      ? 'Pick unlocked badges for your Profile'
      : 'Chọn huy hiệu đã mở hiển thị trên trang Cá nhân';
  String get profileBadgeClearAll => _isEn ? 'Clear all' : 'Xóa hết';
  String profileBadgesOnProfile(int count) =>
      _isEn ? '$count on profile' : '$count trên hồ sơ';
  String get profileBadgePreview =>
      _isEn ? 'Profile preview' : 'Xem trước hồ sơ';
  String get profileBadgeTapToSelect => _isEn
  ...
  String get currentPassword =>
      _isEn ? 'Current password' : 'Mật khẩu hiện tại';
  ...
  String get pleaseEnterUsername =>
      _isEn ? 'Please enter a username' : 'Vui lòng nhập tên người dùng';
  String get sameUsername => _isEn
      ? 'New name is the same as current!'
      : 'Tên mới trùng với tên hiện tại!';
  String get pleaseEnterPassword =>
      _isEn ? 'Please enter your password' : 'Vui lòng nhập mật khẩu xác nhận';
  String get usernameChanged =>
      _isEn ? 'Username changed successfully!' : 'Đổi tên thành công!';
  ...
  String get emailNotFound => _isEn
      ? 'Error: User email not found.'
      : 'Lỗi: Không tìm thấy email người dùng.';
  ...
  String get pleaseFillAllFields =>
      _isEn ? 'Please fill in all fields' : 'Vui lòng điền đủ thông tin';
  String get passwordsDoNotMatch =>
      _isEn ? 'New passwords do not match!' : 'Mật khẩu mới không khớp!';
  ...
  String get accountDeleted =>
      _isEn ? 'Account deleted successfully.' : 'Đã xóa tài khoản thành công.';
  String get typePasswordToConfirm =>
      _isEn ? 'Enter your password to confirm' : 'Nhập mật khẩu để xác nhận';
  ...
  String get chatbotFallback =>
      _isEn ? "I don't understand..." : 'Tôi không hiểu ý bạn...';
  String connectionError(String e) =>
      _isEn ? 'Connection error: $e' : 'Lỗi kết nối: $e';
  ...
  String get clearChatHistory =>
      _isEn ? 'Clear chat history' : 'Xóa lịch sử chat';
  ...
  String get passwordChangedSuccess => _isEn
      ? 'Password changed successfully!'
      : 'Thành công: Đã đổi mật khẩu mới!';
  String get notLoggedIn =>
      _isEn ? 'Error: You are not logged in.' : 'Lỗi: Bạn chưa đăng nhập.';
  ...
  String get accountNotFound =>
      _isEn ? 'Error: Account not found.' : 'Lỗi: Không tìm thấy tài khoản.';
  String get sessionInvalid => _isEn
      ? 'Error: Session is invalid.'
      : 'Lỗi: Phiên đăng nhập không hợp lệ.';
  String get incorrectPassword => _isEn
