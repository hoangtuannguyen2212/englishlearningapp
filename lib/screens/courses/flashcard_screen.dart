    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Spacer(),
          Text(AppStrings.of(context).tapToSeeExamples, style: const TextStyle(color: Colors.grey, fontSize: 14)),
          const SizedBox(height: 20),
        ],
      ),
    );
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Center(
            child: Text(
                AppStrings.of(context).definition,
          ...
          // 2. PHẦN VÍ DỤ
          Text(
              AppStrings.of(context).examples,
